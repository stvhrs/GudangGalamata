...
        
        // Isi Body Tabel juga akan BOLD karena setting global doc.setFont(fontName, 'bold')
...
    doc.setFontSize(9); 
    // doc.setFont(fontName, 'bold'); // Sudah di set global
    doc.text('Total Buku:', margin.left, summaryY);
    // Teks angka total buku juga BOLD
...
    if (!isInvoice) {
        doc.setFontSize(9); 
        // doc.setFont(fontName, 'normal'); // Dibuat BOLD
